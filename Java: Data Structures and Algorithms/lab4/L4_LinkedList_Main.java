import code.MyLinkedList_651514;
...
public class L4_LinkedList_Main {
    ...
    static void demo1() {
        MyLinkedList_651514 list = new MyLinkedList_651514();
        list.add(5);
        list.add(1);
        list.insert(4);
        list.insert(3);
    ...
    static void demo2() {
        MyLinkedList_651514 mList = new MyLinkedList_651514();
        mList.insert(50);
        mList.insert(40);
        mList.insert(30);
        mList.insert(20);
